    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="relative z-[2] text-white md:text-left text-center">
          <p className="text-white text-4xl font-black mt-2.5 text-center md:text-left mb-7 mt-14">Bilgi Notları</p>
          <h1 className="mt-2">
            ...
            <a href="/bilgi" className="text-white no-underline font-bold hover:opacity-80 text-xl">
              <span>Bilgi Notları</span>
            </a>
          </h1>
        </div>
      </div>
